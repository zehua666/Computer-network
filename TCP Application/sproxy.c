...
//  Sporxy.c
//
//  Created by Zehua Zhang <zehuazhang@email.arizona.edu>
//           & Wenkai Zheng <wenkaizheng@email.arizona.edu>
//  Copyright @ 2020 Zehua Zhang and Weikai Zheng. All rights reserved.
//
...
// transfer input string number from stdin to integer port number
